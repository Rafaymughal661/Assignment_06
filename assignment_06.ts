...
var alien_color:string[] = ["green", "yellow", "red"];
function value_(alien_color:string[]) {
  for (let index = 0; index < alien_color.length; index++) {
...
function Fruits(favorite_fruits:string[]) {
...
let A_Names:string[] = ["Admin","Rafay","Ali","Ahmad","Hussain"];
function userName(A_Names:string[]) {
...
// Example usage
const currentUsers: string[] = ["Rafay","Ali","Fakhar","Asif","Naseem"];
const newUsers: string[] = ["RAFAY", "Shaheen", "FAKHAR", "Haris", "Zaman"];
